...
<nav class="bg-white shadow-lg py-4 fixed w-full top-0 z-50 transition-all duration-300" id="navbar">
    <div class="container mx-auto px-4 flex justify-between items-center">
        <div class="flex items-center space-x-10">
            <a href="/" class="font-bold text-2xl bg-green-600 to-blue-600 bg-clip-text text-transparent" data-aos="fade-right" data-aos-duration="800">
                <i class="fas fa-leaf mr-2"></i>Renewa
            </a>
            <div class="hidden md:flex space-x-8">
                <a href="{{ route('welcome') }}" class="{{ request()->routeIs('welcome') ? 'text-green-600 font-semibold border-b-2 border-green-600' : 'text-gray-700 hover:text-green-600 font-medium' }} transition-all duration-300 hover:scale-105" data-aos="fade-down" data-aos-delay="100">
                    <i class="fas fa-home mr-1"></i>Beranda
                </a>
                <a href="{{ route('generatormap') }}" class="{{ request()->routeIs('generatormap') ? 'text-green-600 font-semibold border-b-2 border-green-600' : 'text-gray-700 hover:text-green-600 font-medium' }} transition-all duration-300 hover:scale-105" data-aos="fade-down" data-aos-delay="200">
