...
<body class="bg-gray-50">
    ...
    <main class="flex flex-col items-center mt-8">
        <div class="w-full max-w-4xl">
            <iframe src="https://www.google.com/maps/d/embed?mid=1cG4o5P8LSzr-ZB1WL2oK9rV8Ic7I77g&ehbc=2E312F&noprof=1" width="640" height="480" class="w-full" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>
        @auth
            <a href="{{ route('buyer.categoryselect') }}" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg mt-4 mb-8 flex items-center space-x-2">
                <i class="fas fa-shopping-cart"></i>
                <span>Beli REC</span>
            </a>
        @else
            <a href="{{ route('buyer.login') }}" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg mt-4 mb-8 flex items-center space-x-2">
                <i class="fas fa-shopping-cart"></i>
                <span>Beli REC</span>
            </a>
        @endauth
