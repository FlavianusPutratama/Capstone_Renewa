...
<body class="bg-gray-50 overflow-x-hidden">
    ...
    <div class="overflow-hidden">
        ...
        <section class="py-12 bg-white w-full">
            <div class="container mx-auto px-4 text-center">
                ...
                <div class="grid grid-cols-2 md:grid-cols-6 gap-8">
                    <div class="flex justify-center items-center hover-lift" data-aos="zoom-in" data-aos-delay="100"><img src="{{ asset('images/Pertamina Logo.png') }}" alt="Pertamina" class="h-10"></div>
                    <div class="flex justify-center items-center hover-lift" data-aos="zoom-in" data-aos-delay="200"><img src="{{ asset('images/Indofood Logo.png') }}" alt="Indofood" class="h-10"></div>
                    <div class="flex justify-center items-center hover-lift" data-aos="zoom-in" data-aos-delay="300"><img src="{{ asset('images/Pama Logo.png') }}" alt="Pama" class="h-10"></div>
                    <div class="flex justify-center items-center hover-lift" data-aos="zoom-in" data-aos-delay="400"><img src="{{ asset('images/Telkom Logo.png') }}" alt="Telkom" class="h-10"></div>
                    <div class="flex justify-center items-center hover-lift" data-aos="zoom-in" data-aos-delay="500"><img src="{{ asset('images/MRT Jakarta Logo.png') }}" alt="MRT Jakarta" class="h-10"></div>
                    <div class="flex justify-center items-center hover-lift" data-aos="zoom-in" data-aos-delay="600"><img src="{{ asset('images/Mandiri Logo.png') }}" alt="Mandiri" class="h-10"></div>
                </div>
            </div>
        </section>
        ...
        <section id="track-section" class="py-16 bg-gray-50 w-full" data-aos="fade-up">
            <div x-data="{ searchBy: 'id' }" class="container mx-auto px-4 text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4">Lacak Transparansi REC Anda</h2>
                <p class="text-gray-600 max-w-2xl mx-auto mb-8">
                    Pilih mode pencarian berdasarkan <span x-show="searchBy === 'id'"><b>ID Unik</b> untuk melihat detail sertifikat</span><span x-show="searchBy === 'company'"><b>Nama Perusahaan</b> untuk melihat riwayat pembelian</span>.
                </p>
                
                <div class="flex justify-center items-center mb-6">
                    <span :class="{'font-bold text-green-600': searchBy === 'id'}" class="px-4 py-2 cursor-pointer transition-colors" @click="searchBy = 'id'">ID Unik</span>
                    <div @click="searchBy = (searchBy === 'id' ? 'company' : 'id')" class="w-14 h-8 flex items-center bg-gray-300 rounded-full p-1 cursor-pointer transition-colors duration-300" :class="{'bg-green-500': searchBy === 'company'}">
                        <div class="w-6 h-6 bg-white rounded-full shadow-md transform transition-transform duration-300" :class="{'translate-x-6': searchBy === 'company'}"></div>
                    </div>
                    <span :class="{'font-bold text-green-600': searchBy === 'company'}" class="px-4 py-2 cursor-pointer transition-colors" @click="searchBy = 'company'">Nama Perusahaan</span>
                </div>
                ...
                <form 
                    ...
                    <div class="w-full">
                        <input 
                            type="text" 
                            id="search_input"
                            :name="searchBy === 'id' ? 'order_id' : 'company_name'" 
                            :placeholder="searchBy === 'id' ? 'Contoh: REC-TRX-ABC12345' : 'Masukkan nama perusahaan...'" 
                            class="w-full py-3 px-6 text-gray-700 leading-tight focus:outline-none border-none bg-transparent" 
                            required>
                    </div>
