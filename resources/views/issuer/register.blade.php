<!-- resources/views/issuer/register.blade.php -->
<x-guest-layout>
    <div class="mb-4 text-center">
        <h2 class="text-2xl font-bold text-gray-800">Daftar sebagai Penerbit REC</h2>
        <p class="text-gray-600">Buat akun untuk menerbitkan dan mengelola sertifikat energi terbarukan</p>
    </div>

    <form method="POST" action="{{ route('issuer.register') }}">
        @csrf
        ...
        <div class="flex items-center justify-between mt-6">
            <a class="text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" href="{{ route('issuer.login') }}">
                {{ __('Sudah punya akun?') }}
            </a>
