...
<body class="bg-gray-50">
    ...
    <main class="py-16 bg-gradient-to-br from-green-50 via-white to-green-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="mt-16 grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
                ...
                class="w-full aspect-square bg-white rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex flex-col items-center justify-center p-6 group">
                @csrf
