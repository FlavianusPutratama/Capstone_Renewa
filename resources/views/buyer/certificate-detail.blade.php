...
<head>
    ...
    <title>Sertifikat REC Saya - Pesanan #{{ $order->order_uid }}</title>
            ...
            <div class="max-w-4xl mx-auto certificate-bg rounded-2xl shadow-xl p-8 md:p-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    <div>
                        ...
                        {{-- KODE DIPERBAIKI DI BARIS BERIKUT UNTUK MENJAGA STYLING --}}
                        <p class="text-2xl font-bold text-gray-900">{{ ($order->category === 'Enterprise' && $order->buyer->company) ? $order->buyer->company->name : $order->buyer->name }}</p>
                    </div>
                ...
                <div class="text-center mt-12">
                    <a href="{{ route('buyer.orders.show', $order->id) }}" class="text-green-600 hover:text-green-800 font-medium transition-colors">
